  ...
  >
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="auth-form space-y-6" @submit.prevent="submit">
        <div>
          <label for="register-display-name" class="block text-sm/6 font-medium text-zinc-900">Display name</label>
          <div class="mt-2">
            <input
        ...
        <div>
          <label for="register-email" class="block text-sm/6 font-medium text-zinc-900">Email address</label>
          <div class="mt-2">
            <input
              id="register-email"
          ...
          <p v-if="emailStatus" class="mt-2 text-sm" :class="emailStatusClass">
            {{ emailStatus }}
          </p>
        </div>

        <div>
          <label for="register-password" class="block text-sm/6 font-medium text-zinc-900">Password</label>
          <div class="mt-2">
            <input
      ...
      <p class="mt-10 text-center text-sm text-zinc-600">
        ...
        <NuxtLink to="/login" class="font-semibold text-primary hover:text-primary/80">Sign in</NuxtLink>
      </p>
    </div>
  </div>
</template>
