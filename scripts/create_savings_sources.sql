-- Stores user-defined savings sources for the Budget Tracker "From" field
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_savings_sources_owner_name
  ON savings_sources(user_id, COALESCE(group_id, 0), LOWER(name));
