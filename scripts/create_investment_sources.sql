-- Stores user-defined investment sources for the Budget Tracker "From" field
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_investment_sources_owner_name
  ON investment_sources(user_id, COALESCE(group_id, 0), LOWER(name));
