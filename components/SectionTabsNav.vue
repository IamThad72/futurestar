<template>
  <div class="sticky top-0 z-20 border-b border-gray-200 bg-base-200 px-4 py-3 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
      <div class="grid grid-cols-1 sm:hidden">
        <select
          :aria-label="`Select a ${ariaLabel} tab`"
          class="select select-bordered w-full min-h-11 bg-base-100 text-base text-base-content"
          :value="currentHref"
          @change="onSelectTab"
        >
      ...
      <nav class="hidden overflow-x-auto sm:block" :aria-label="ariaLabel">
